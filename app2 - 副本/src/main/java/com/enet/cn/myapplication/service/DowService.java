...
public class DowService extends Service {
    private static final String TAG = DowService.class.getSimpleName();
    ...
    //初始化下载
    public static void intentDownload(Context context, int position, String tag, Apps info) {
        Intent intent = new Intent(context, DowService.class);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (intent != null) {
            ...
            Apps appInfo = (Apps) intent.getSerializableExtra(EXTRA_APP_INFO);//获取到下载的对象
            String tag = intent.getStringExtra(EXTRA_TAG);
          //  String tag = tag1.replaceAll(tag1, "http://s1.music.126.net/download/android/CloudMusic_2.8.1_official_4.apk");
            Log.e("1111","tag="+tag);
            switch (action) {
    ...
    private void download(final int position, final Apps appInfo,final String tag) {
        final DownloadRequest request = new DownloadRequest.Builder()
                .setName(appInfo.getName() + ".apk")
                .setUri(appInfo.getDownloadurl())
    ...
    public static class DownloadCallBack implements CallBack {
        ...
        public DownloadCallBack(int position, Apps appInfo, NotificationManagerCompat notificationManager, Context context) {
            mPosition = position;
            mAppInfo = appInfo;
        ...
        public void onConnecting() {
            ...
            mBuilder.setContentText("Connecting")
                    .setProgress(100, 0, true);
            updateNotification();
            mAppInfo.setStatus(Apps.STATUS_CONNECTING);
            sendBroadCast(mAppInfo);//往主线程发送通知
        }
        ...
        public void onProgress(long finished, long total, int progress) {
            ...
            mAppInfo.setStatus(Apps.STATUS_DOWNLOADING);
        ...
        public void onCompleted() {
            ...
            mAppInfo.setStatus(Apps.STATUS_COMPLETE);
        ...
        public void onDownloadPaused() {
            ...
            mAppInfo.setStatus(Apps.STATUS_PAUSED);
            sendBroadCast(mAppInfo);
        }
        ...
        public void onDownloadCanceled() {
            ...
            mAppInfo.setStatus(Apps.STATUS_NOT_DOWNLOAD);
        ...
        public void onFailed(DownloadException e) {
            ...
            mAppInfo.setStatus(Apps.STATUS_DOWNLOAD_ERROR);
            sendBroadCast(mAppInfo);
        }
        ...
        private void sendBroadCast(Apps appInfo) {
            Intent intent = new Intent();
            intent.setAction(DowService.ACTION_DOWNLOAD_BROAD_CAST);
